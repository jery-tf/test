...
<template>
  ...
  <section class="showChose">
    <p class="popupTop padding-container-lf">
      <span>
        <i class="C2-guanbi1" style="opacity: 0"></i>
      </span>
      <span>{{title}}</span>
      <span @click="isShowFun(false)">
...
<script>
  ...
  export default {
    name: 'myAddress',
    props: ['pickermore','isShowFun','title'],
    data() {
      return {
...
//        showChose: true,
    ...
    methods: {
      ...
      getProvinceId: function (code, input, index) {
          console.log('getProvinceId',code);
        this.province = code;
        this.Province = input;
