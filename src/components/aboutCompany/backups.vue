  ...
  <section class="showChose" v-show="showChose">
    <section class="address">
      ...
      <section class="title" :province1="this.Province">
        ...
        <div class="area" @click="districtSelected()" :class="District?'':'active'" v-show="City">{{District ? District : '请选择'}}
        </div>
      ...
      <ul>
        ...
        <li class="addList" v-for="(v,k) in showDistrictList" @click="getDistrictId(v.id, v.name, k)" v-show="showDistrict"
            :class="v.selected ? 'active' : ''">{{v.name}}
        </li>
...
//         点击选择当前
        ...
        Api.pickerAreaApi.pickerAreas(this.province).then(res => {
